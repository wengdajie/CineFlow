...
async def enable(plugin_id: str, user: SuperUser) -> Message:
...
async def disable(plugin_id: str, user: SuperUser) -> Message:
...
async def update_config(
    plugin_id: str, payload: PluginConfigUpdate, user: SuperUser
) -> Message:
...
async def run_action(
    plugin_id: str, payload: PluginActionRequest, user: CurrentUser
) -> dict[str, Any]:
    try:
